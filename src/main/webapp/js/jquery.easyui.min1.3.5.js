    ...
    function _375(_376, _377, _378) {
        ...
        function _37e() {
            ...
            if (_377 == "east") {
                ...
                return {
                    resizeC: {width: ww},
                    expand: {left: cc.width() - _37a.width},
                    expandP: {top: _380.top, left: cc.width() - 28, width: 28, height: _380.height},
                    collapse: {left: cc.width(), top: _380.top, height: _380.height}
                };
            } else {
                if (_377 == "west") {
                    var ww = _380.width + _37a.width - 28;
                    ...
                    return {
                        resizeC: {width: ww, left: 28 - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _380.top, width: 28, height: _380.height},
                        collapse: {left: -_37a.width, top: _380.top, height: _380.height}
                    };
                } else {
                    if (_377 == "north") {
                        var hh = _380.height;
                        ...
                        return {
                            resizeC: {top: 28 - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: 28},
                            collapse: {top: -_37a.height, width: cc.width()}
                        };
                    } else {
                        if (_377 == "south") {
                            var hh = _380.height;
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _37a.height},
    ...
    function _381(_382, _383) {
        ...
        function _387() {
            ...
            if (_383 == "east" && _384.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _389.top, height: _389.height},
                    expand: {left: cc.width() - _384["east"].panel("options").width}
                };
            } else {
                if (_383 == "west" && _384.expandWest) {
                    return {
                        collapse: {left: -_384["west"].panel("options").width, top: _389.top, height: _389.height},
                        expand: {left: 0}
                    };
                } else {
                    if (_383 == "north" && _384.expandNorth) {
                        return {
                            collapse: {top: -_384["north"].panel("options").height, width: cc.width()},
                            expand: {top: 0}
                        };
                    } else {
                        if (_383 == "south" && _384.expandSouth) {
                            return {
                                collapse: {top: cc.height(), width: cc.width()},
                                expand: {top: cc.height() - _384["south"].panel("options").height}
                            };
                        }
                    }
                }
...
(function ($) {
    ...
    $.fn.splitbutton.defaults = $.extend({}, $.fn.linkbutton.defaults, {
        ...
        menu: null,
        duration: 100,
        cls: {btn1: "s-btn-active", btn2: "s-btn-plain-active", arrow: "s-btn-downarrow", trigger: "s-btn-downarrow"}
    });
})(jQuery);
(function ($) {
    function init(_3ec) {
    ...
    $.fn.searchbox.defaults = {
        width: "auto", height: 22, prompt: "", value: "", menu: null, searcher: function (_408, name) {
        }
    };
})(jQuery);
(function ($) {
